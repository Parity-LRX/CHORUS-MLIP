...
def EnergyModel(
    ...
    if interaction_backend == "e3nn":
        ...
        if openequivariance_enabled:
            raise ValueError(
                "OpenEquivariance currently accelerates only the e3nn "
                "interaction backend; the ICTC angular product requires a "
