...
def plot_curves(curve_rows: list[dict[str, object]], out_dir: Path) -> None:
    ...
    colors = {
        "ictc_phase_full_l_pair_balanced_makefx": "#59a14f",
        "ictc_phase_full_l_gated_local_makefx": "#54a24b",
        "ictc_phase_full_l_gated_makefx": "#72b7b2",
        "ictc_phase_full_l_local_makefx": "#b279a2",
        "ictc_phase_diagonal_full_l_makefx": "#f2cf5b",
        "ictc_phase_full_l_softplus_makefx": "#e45756",
        "ictc_attention_makefx": "#4c78a8",
    ...
    labels = {
        "ictc_phase_full_l_pair_balanced_makefx": "CHORUS pair-count balanced",
        "ictc_phase_full_l_gated_local_makefx": "CHORUS gated + local norm",
        "ictc_phase_full_l_gated_makefx": "CHORUS coherence gate",
        "ictc_phase_full_l_local_makefx": "CHORUS local norm",
        "ictc_phase_diagonal_full_l_makefx": "Diagonal $j=k$ compiled",
        "ictc_phase_full_l_softplus_makefx": "CHORUS-Final compiled",
        "ictc_attention_makefx": "Attention compiled",
