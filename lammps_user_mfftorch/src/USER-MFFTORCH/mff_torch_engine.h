...
class MFFTorchEngine {
 public:
  ...
  const std::string& long_range_assignment() const { return long_range_assignment_; }
  ...
  double dispersion_min_cutoff() const { return dispersion_min_cutoff_; }
  double dispersion_switch_width() const { return dispersion_switch_width_; }
  ...
  double long_range_mbd_energy_scale() const { return long_range_mbd_energy_scale_; }
 ...
 private:
  ...
  double dispersion_min_cutoff_ = 0.0;
  double dispersion_switch_width_ = 0.5;
  ...
  double long_range_mbd_energy_scale_ = 1.0;
