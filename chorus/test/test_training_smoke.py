"""Smoke test for the MACE-ICTC training stack (data + ForceTrainer + bucketing).

Run:  python -m chorus.test.test_training_smoke
...
from chorus.cli.train import build_baseline_model, _avg_num_neighbors_from_h5
...
def run(device="cpu"):
    ...
    tmp = tempfile.mkdtemp(prefix="mace_ictc_test_")
