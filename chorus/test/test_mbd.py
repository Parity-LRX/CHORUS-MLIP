...
from chorus.models.mbd import dipole_field
...
def test_lanczos_quadform_exact():
    ...
    torch.set_default_dtype(torch.float64)
    from chorus.models.mbd import lanczos_sqrt_quadform
...
def test_slq_trace_sqrt_matches_dense():
    ...
    torch.set_default_dtype(torch.float64)
    from chorus.models.mbd import coupled_dipole_matvec, make_probes, slq_trace_sqrt
...
def test_slq_energy_conservative_gradient():
    ...
    torch.set_default_dtype(torch.float64)
    from chorus.models.mbd import mbd_energy_slq, mbd_energy_slq_lowmem
