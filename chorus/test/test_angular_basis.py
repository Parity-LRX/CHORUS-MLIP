...
symmetric contraction is run in the stable ICTC basis with an exact e3nn<->ICTC rotation at its
...
Run:  python -m chorus.test.test_angular_basis
"""
import torch

from chorus.synthetic import build_model, make_fixed_graph, compute_energy_forces
from chorus.models.pure_cartesian_ictd_fix import SO3ToE3NNBasisBridge
