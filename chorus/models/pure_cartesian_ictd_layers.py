...
from chorus.models.radial_basis import soft_one_hot_linspace_mace_cutoff as soft_one_hot_linspace
import math
...
from chorus.models.ictd_fast import _counts_list
from chorus.models.mlp import RobustScalarWeightedSum
from chorus.models.mlp import MainNet
from chorus.models.long_range import apply_long_range_modules, configure_long_range_modules
...
def _sym_rank_linear_indices_and_coefs(L: int) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    Ordering of (a,b,c) follows `chorus.models.ictd_fast._counts_list(L)`,
