...
Usage (from project root):
  torchrun --nproc_per_node=2 -m chorus.cli.inference_ddp --atoms 100000
  torchrun --nproc_per_node=2 -m chorus.cli.inference_ddp --atoms 50000 --forces   # output energy and forces
...
from chorus.models.pure_cartesian_ictd_layers import PureCartesianICTDTransformerLayer
...
def main():
    ...
    try:
        ...
        print("DDP requires torchrun, e.g.: torchrun --nproc_per_node=2 -m chorus.cli.inference_ddp --atoms 100000")
